...
public class ProtocolTests
{
    ...
    public async Task CrossLanguage_DeserializeRustGeneratedSnapshot()
    {
        ...
        Assert.True(
            ...
            $"Cross-language test data file not found at: {testDataPath}. Ensure 'server/Tests/data/cross-language-snapshot.bin' exists (or run the Rust cross-language test suite to regenerate it)."
        );
